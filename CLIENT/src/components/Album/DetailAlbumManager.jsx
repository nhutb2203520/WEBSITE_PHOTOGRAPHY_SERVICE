...
import { 
    ArrowLeft, Calendar, MapPin, User, Package, 
    UploadCloud, Trash2, Edit2, Save, X, Image as ImageIcon,
    ChevronLeft, ChevronRight, FileText, Info, Share2, Copy, Check, Send, CheckCircle, Star, PlusCircle
} from 'lucide-react';
...
export default function DetailAlbumManager() {
    ...
    const handleDeliverFileSelect = (e) => {
        const files = Array.from(e.target.files);
        if (files.length > 0) {
            // Cho phép thêm nhiều file, không ghi đè
    ...
    return (
        <div className="layout-wrapper">
                    ...
                    <div className="pam-container">
                        <div className="pam-header">
                            ...
                            <div className="header-actions-right">
                                {/* Nút Giao Album - LUÔN HIỆN (để giao thêm) */}
                                {order && (
                                    <button 
            ...
            {/* MODAL GIAO ALBUM (Cho phép chọn nhiều file) */}
            {showDeliverModal && (
                <div className="modal-overlay" onClick={() => setShowDeliverModal(false)}>
                    <div className="modal-content deliver-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            {/* Danh sách file đã chọn trong Modal */}
